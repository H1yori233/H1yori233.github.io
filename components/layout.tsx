...
export function Layout({
  ...
  const contentWrapperClasses = !fullWidth ? "w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" : ""
  ...
  return (
    ...
    >
      ...
      <main className={cn("flex-grow", !customNav && (title || description) && "pt-16")}>
        {(title || description) && (
          <motion.div
        ...
        <div className={cn("flex-grow", contentWrapperClasses)}>
          {children}
        </div>
      </main>
      ...
      {showScrollToTop && (
        <Button
          ...
          size="icon"
          className={cn(
            "fixed bottom-20 right-4 z-50 transition-all duration-200",
